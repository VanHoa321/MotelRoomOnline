...
namespace MotelRoomOnline.Areas.Landlord.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var items = _context.Posts.Where(p => p.AccountId == Functions.account.AccountId).OrderByDescending(p => p.PostId).ToList();
        ...
        {
            var items = _context.Posts.Where(p => p.AccountId == Functions.account.AccountId).OrderByDescending(p => p.PostCategoryId).Take(10).ToList();
